...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ease-in-out ${scrolled ? 'bg-snow/95 backdrop-blur-md py-3.5 border-b border-petal/20 shadow-sm' : 'bg-transparent py-5'}`}>
